...
/**
 *
 * Аннотации - это специальный тип комментариев в коде с помощью которых можно:
 * 1) Передавать какие-либо инструкции для компилятора
 * 2) Передавать какие либо инструкции для анализаторов исходного кода
 * 3) Передавать метаданные, которые могут быть использованы в приложении (с помощью рефлексии), либо другими приложениями
 * или фреймворками
 *
 * Аннотации - это средство языка, по сути это просто ярлык - разметка для дальнейшей обработки.
